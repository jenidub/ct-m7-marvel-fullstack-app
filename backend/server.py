...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:JWhod94612!@localhost/marvel'
...
def create_database():
    root_engine = create_engine("mysql+mysqlconnector://root:JWhod94612!@localhost")  # No database specified
